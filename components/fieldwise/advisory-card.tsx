...
import { AlertTriangle, Chec/** Renders actionable agricultural advice based on multimodal analysis */
'use client';
...
export const AdvisoryCard = React.memo(function AdvisoryCard({
  severity,
  safeWindow,
  weather,
  previewUrl,
...
});kCircle2, Leaf, Sparkles } from 'lucide-react';
import { Badge } from '@/components/ui/badge';
import { CATEGORY_ADVICE } from '@/lib/leaf-analysis';
import type { SeverityResult, SafeWindow, WeatherForecast } from '@/lib/types';
import { formatTime } from '@/lib/weather';
